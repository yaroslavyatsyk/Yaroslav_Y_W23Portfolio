...
export default function Contact() {
  ...
  return (
    ...
    <section id="contact">
     ...
     <a className="text-indigo-400 leading-relaxed" href="https://www.linkedin.com/in/yaroslavyatsyk" aria-label="LinkedIn"><i class="fa fa-linkedin" style={{marginRight: 10 + 'px'}}></i></a>
 <a className="text-indigo-400 leading-relaxed" href="https://github.com/yaroslavyatsyk" aria-label="GitHub"><i class="fa fa-github" style={{marginLeft: 10 + 'px'}}></i></a>
