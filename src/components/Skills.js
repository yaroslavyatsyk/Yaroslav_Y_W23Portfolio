  ...
  return (
    <section id="skills">
      <div className="container px-5 py-5 mx-auto">
        ...
        <h6 className="sm:text-4xl text-3xl font-small  text-white mb-1">Programming languages</h6>
        </div>
        ...
        <div className="text-center">
        <h6 className="sm:text-4xl text-3xl font-small  text-white mb-1">Frameworks</h6>
        </div>
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
        ...
        <div className="text-center">
        <h6 className="sm:text-4xl text-3xl font-small  text-white mb-1">Tools</h6>
        </div>
        <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
          {tools.map((tool) => (
          ...
          <div className="text-center">
          <h6 className="sm:text-4xl text-3xl font-medium  text-white mb-1">Methodologies and Concepts</h6>
          </div>
          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
