export const projects = [
  ...
  },
  {
    ...
    subtitle: "",
    description: "A desktop-based applications demonstrates the concepts of complex numbers, including their properties and arithmetic operations using C#, .NET, WPF, Visual Studio, Git, GitHub.",
...
export const workexperiences = [
  {
    ...
    descriptions: [
      "Developed a character tracing module using C#, .NET, and Visual Studio, enhancing data processing speed by 10%.",
      ...
      "Followed all stages of the Software Development Life Cycle (SDLC) including requirements gathering, design, implementation, testing, maintenance, and support."
  ...
  },
  {
    ...
    descriptions: [
      "Built a web application for an online store using ASP.NET MVC, increasing profits by 25%.",
      "Complied with all phases of the SDLC.",
      "Engineered a robust database using SQL Server Management Studio.",
